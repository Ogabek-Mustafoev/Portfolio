    ...
    <section className="about section">
      <div className="container">
        ...
        <div className="about-content">
          <h3 data-aos='zoom-in-up' data-aos-delay='300'>I'm Ogabek Mustafoev - <span>Front-end Developer</span></h3>
          ...
          <div className="grid-3">
            ...
            <div className="personal-info-2">
              <p data-aos='zoom-in-up' data-aos-delay='500'>Email:
                <span>
                  <a target="_blank" rel="noopener noreferrer" href="mailto:mustafoev0806@gmail.com">ogabek@gmail.com</a>
                </span>
              </p>
